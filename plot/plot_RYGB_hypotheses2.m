function [] = plot_RYGB2(hyp_chars, hyp_chars_R1, hyp_chars_R2, hyp_chars_R3)
...
for it = 1:9
    ...
    y_vals_R1 = zeros(length(hyp_chars{it}),4);
    y_vals_R2 = zeros(length(hyp_chars{it}),4);
    ...
    for it_2 = 1:length(hyp_chars{it})
        try
            ...
            y_vals_R1(it_2,1) = hyp_chars_R1{it}(it_2).fasting_pl;
            y_vals_R1(it_2,2) = 100*hyp_chars_R1{it}(it_2).meal_30 / hyp_chars_R1{it}(it_2).fasting_pl;
            y_vals_R1(it_2,3) = 100*hyp_chars_R1{it}(it_2).meal_max / hyp_chars_R1{it}(it_2).fasting_pl;
            y_vals_R1(it_2,4) = 100*hyp_chars_R1{it}(it_2).fasting_pl_p/hyp_chars_R1{it}(it_2).fasting_pl;
            
            y_vals_R2(it_2,1) = hyp_chars_R2{it}(it_2).fasting_pl;
            y_vals_R2(it_2,2) = 100*hyp_chars_R2{it}(it_2).meal_30 / hyp_chars_R2{it}(it_2).fasting_pl;
            y_vals_R2(it_2,3) = 100*hyp_chars_R2{it}(it_2).meal_max / hyp_chars_R2{it}(it_2).fasting_pl;
            y_vals_R2(it_2,4) = 100*hyp_chars_R2{it}(it_2).fasting_pl_p/hyp_chars_R2{it}(it_2).fasting_pl;
            
            y_vals_R3(it_2,1) = hyp_chars_R3{it}(it_2).fasting_pl;
            y_vals_R3(it_2,2) = 100*hyp_chars_R3{it}(it_2).meal_30 / hyp_chars_R3{it}(it_2).fasting_pl;
            y_vals_R3(it_2,3) = 100*hyp_chars_R3{it}(it_2).meal_max / hyp_chars_R3{it}(it_2).fasting_pl;
            y_vals_R3(it_2,4) = 100*hyp_chars_R3{it}(it_2).fasting_pl_p/hyp_chars_R3{it}(it_2).fasting_pl;
    ...
    for it_3 = 1:4
        ...
        if it>1
            semilogx(x_vals,y_vals(:,it_3), 'LineWidth', 2, 'Color', [0.75 0.75 0.75]); hold on
            semilogx(x_vals,y_vals_R1(:,it_3), '--','LineWidth', 2, 'Color', cs{it}); hold on
            semilogx(x_vals,y_vals_R2(:,it_3), '-.','LineWidth', 2, 'Color', cs{it}); hold on
            semilogx(x_vals,y_vals_R3(:,it_3), ':','LineWidth', 2, 'Color', cs{it}); hold on
        else
            plot(x_vals,y_vals(:,it_3), 'LineWidth', 2, 'Color', [0.75 0.75 0.75]); hold on
            plot(x_vals,y_vals_R1(:,it_3), '--','LineWidth', 2, 'Color', cs{it}); hold on
            plot(x_vals,y_vals_R2(:,it_3), '-.','LineWidth', 2, 'Color', cs{it}); hold on
            plot(x_vals,y_vals_R3(:,it_3), ':','LineWidth', 2, 'Color', cs{it}); hold on
        end
